...
import 'package:flutter_proj/dino/game/dino.dart';
...
import 'package:flutter_proj/dino/game/enemy_manager.dart';
import 'package:flutter_proj/dino/models/player_data.dart';
import 'package:flutter_proj/dino/widgets/pause_menu.dart';
import 'package:flutter_proj/dino/widgets/game_over_menu.dart';
...
class DinoRun extends FlameGame with TapDetector, HasCollisionDetection {
  ...
  void update(double dt) {
    ...
    if (changer.selectedOpt_quiz == 1) {
      if (overlays.isActive(Hud.id)) {
        _dino.jump();
        changer.headUp = false;
